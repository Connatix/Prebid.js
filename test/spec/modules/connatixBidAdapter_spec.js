...
describe('connatixBidAdapter', function () {
  ...
  describe('wrapAd', function () {
    ...
    it('Should return a string containing omid for inApp cases', function () {
      inApp = true;
      const ad = connatixWrapAd(lineItems, requestId, playerId, customerId, inApp);
      expect(ad).to.contain('omid');
    });

    it('Should return a string that is not containing omid for non inApp cases', function () {
      const ad = connatixWrapAd(lineItems, requestId, playerId, customerId, inApp);
      expect(ad).to.not.contain('omid');
    });
